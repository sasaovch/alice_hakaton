...
fun main() {
    ...
    val ans1 = RequestHandler.getFreeRooms(Room(Place.KRONVERSKY, Pair(10, 0), 30, Month.MARCH, 1311, RoomType.MEETINGROOM, 30, DayOfWeek.NONE, 5), user)
    println(ans1)
    val ans2 = RequestHandler.bookRoom(Room(Place.KRONVERSKY, Pair(10, 0), 30, Month.MARCH, 1311, RoomType.MEETINGROOM, 90, DayOfWeek.NONE, 5), user)
